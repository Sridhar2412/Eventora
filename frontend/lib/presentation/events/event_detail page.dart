...
final rsvpCheckProvider = StateProvider.family<bool, int>((ref, type) {
  return false;
});
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: Assets.images.event.image(
                      fit: BoxFit.fill, width: context.width, height: 250),
                ),
                Gap(20),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    InkWell(
                      onTap: () => context.pushRoute(ViewOnMapRoute(
                        ...
                        lat: double.tryParse(
                                state.data.myEvent?.latitude ?? '') ??
                            0,
                        lang: double.tryParse(
                                state.data.myEvent?.longitude ?? '') ??
                            0,
                        // lang: 19.114303,
                        // lat: 72.867943,
